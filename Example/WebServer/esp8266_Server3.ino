...
String getPage() {
    String page = "<html lang='en'><head><meta http-equiv='refresh' content='10'/>";
    page += "<title>ESP8266 Server Demo</title>";
    page += "<style> body { background-color: #fffff; font-family: Arial, Helvetica, Sans-Serif; Color: #000088; }</style>";
    page += "</head><body><h1>ESP8266 Demo</h1>";
    page += "<h2>Sensing & Control Mini station</h2>";
    page += "<h3>BME280</h3>";
    ...
    page += "<p><a href='https://github.com/dcback/ESP8266/blob/master/Example/WebServer/esp8266_Server3.ino' target='_blank'>GithubLink</p>";
    page += "</body></html>";
    return page;
}
